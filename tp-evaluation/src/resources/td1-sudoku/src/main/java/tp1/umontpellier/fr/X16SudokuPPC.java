...
public class X16SudokuPPC {
	...
	public static void main(String[] args) throws ParseException, IOException {
		...
		String myFile = "//home/pourtoi/Bureau/MesProjetVscode/td1-sudoku/src/ressource/X16SudokuPPC.txt";
		new X16SudokuPPC().solveFichier(myFile);
	...
	public void solveFichier(String myFile) throws IOException {
		...
		for (int i = 0; i < n; i++) {
			...
			for (int j = 0; j < n; j++) {
				if (rows[i][j].getValue() > 9)
					...
					System.out.print(esp + list.get(rows[i][j].getValue()-10) + " │ ");
